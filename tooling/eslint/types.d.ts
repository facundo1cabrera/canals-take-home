...
declare module "eslint-plugin-sort-exports" {
  ...
  interface SortExportsRuleOptions {
    sortDir?: "asc" | "desc";
    ignoreCase?: boolean;
    sortExportKindFirst?: "type" | "value";
  }

  interface PluginSortExports extends TSESLint.FlatConfig.Plugin {
    rules: {
      "sort-exports": TSESLint.RuleModule<"unsorted", [SortExportsRuleOptions]>;
    };
  }

  const plugin: PluginSortExports;
  export = plugin;
}
